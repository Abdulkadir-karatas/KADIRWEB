...
const ContactSection: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'contact' | 'comments'>('contact')
  ...
  const toggleTab = () => {
    setActiveTab(prev => prev === 'contact' ? 'comments' : 'contact')
  }
              ...
              <div className="flex flex-col gap-5 h-full">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-2">
                  ...
                  <div className="text-sm font-medium">
                    ...
                    {status === 'error' && (
                      <span className="text-red-400">Gönderim hatası.</span>
                    )}
                  </div>
